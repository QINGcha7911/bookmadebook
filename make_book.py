...
def generate_xhs(book: str, api_key: str, script_path: Path | None = None) -> str:
    ...
    system = "你是擅长图书种草的小红书文案编辑，文案要干货、克制、有钩子。"
    user = f"""书名：《{book}》
主题参考：{topic}

这是 AI 生成的一篇 10 分钟讲书精读视频的小红书文案，视频要点：讲透全书核心脉络、关键人物与兴衰主线。
...
## 正文
4-6 行口语化正文：突出"10分钟讲透这本书"的价值（如：不用啃原著、关键脉络/人物讲清楚、适合通勤/睡前听），每行不超过 30 字，不要出现“想听什么就生成什么”之类的广告语。
